...
public class GeradorEstatisticasDownloadsPorIdade implements IGeradorEstatisticas {
	...
	public String gerar() {
		...
		double porcentagemCriancas = downloadDietaDAO.contarDownloadPorFaixaEtaria(1, 11);
		double porcentagemAdolescentes = downloadDietaDAO.contarDownloadPorFaixaEtaria(12, 18);
		double porcentagemAdultos = downloadDietaDAO.contarDownloadPorFaixaEtaria(19, 40);
		double porcentagemIdosos = downloadDietaDAO.contarDownloadPorFaixaEtaria(41, 200);
